...
// Base URL
// Auto-detect base URL atau gunakan manual jika diperlukan
$protocol = isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https://' : 'http://';
$host = $_SERVER['HTTP_HOST'] ?? 'localhost';
$script_path = str_replace('\\', '/', dirname($_SERVER['SCRIPT_NAME']));
$base_path = rtrim($script_path, '/') . '/';

// Jika base_path adalah '/', maka tidak perlu tambahan
if ($base_path === '//') {
    $base_path = '/';
}
...
/**
 * Helper function to safely escape and get array value
 */
function escape_array_get($array, $key, $default = '') {
